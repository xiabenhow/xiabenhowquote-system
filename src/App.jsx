...
const COURSE_MATERIALS = {
  ...
  '花圈蠟片': ['圓蠟片模具', '鐵釦', '花材包', '1/2橙片'],
  '甜點蠟': ['馬芬蛋糕杯', '5ml精油', '細燭芯', '塑膠盒'],
  '海洋蠟': ['玻璃杯+蓋子', '貝殼砂', '細燭芯', '小牛皮盒+繩'],

  // --- 環氧系列 & 水晶系列 ---
  '環氧夜燈': ['英文模具', '燈座', 'ＡＢ膠', '環氧顏料'],
  '環氧雙杯墊托盤': ['熱風槍', '托盤', '杯墊', '環氧顏料'],
  '水晶手鍊': ['水晶講義', '出課水晶', '剪刀', '長尾夾'],
  '水晶樹': ['水晶樹枝', 'moss草', '吊牌', '尖嘴鉗'],
  '水晶吊飾': ['小卡', '出課水晶（要帶吊牌）', '剪刀', '35cm鐵絲'],

  // --- 法式調香系列 ---
  '法式調香': ['調香講義', '黑抽屜盒', '抽屜盒蓋子', '原子筆'],
  '沐浴精': ['講義', '原子筆', '水量壺', '刻度量杯'],
};
